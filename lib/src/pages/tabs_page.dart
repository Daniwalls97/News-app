...
class TabsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      // Así mantengo la intancia global
...
class _NavegacionModel with ChangeNotifier {
  ...
  set paginaActual(int valor) {
    ...
    //Notifica a todos los widgets que el valor se ha cambiado
    //Con esto los widgets pendientes, podrán redibujarse en función al valor
    notifyListeners();
  }
